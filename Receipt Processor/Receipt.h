...
{
public:
	Receipt2() : retailer(""), pdate("1900-01-01"), ptime("12:00"), items(), total(0)
	{}
	Receipt2(const std::string& retailer, const std::string& pdate, const std::string& ptime, const std::vector<Item>& items, const double total) :
